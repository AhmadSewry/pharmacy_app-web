...
function PainRelief() {
  const [products, setProducts] = useState(
    ProductsData.filter((product) => product.category === "Pain Relief")
  );
  ...
  const handleClose = () => {
    setOpen(false);
    setErrors({ name: "", price: "" }); // Reset errors when closing the dialog
  };
  ...
  return (
    <>
      <TableContainer component={Paper}>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="pain relief products table">
          <TableHead>
            <TableRow>
        ...
        <DialogContent>
          ...
          >
            <TextField
              ...
              sx={{ "& .Mui-error": { color: "red" }, "& .MuiFormHelperText-root": { color: "red" } }}
            />
            <TextField
              label="Description"
              name="description"
