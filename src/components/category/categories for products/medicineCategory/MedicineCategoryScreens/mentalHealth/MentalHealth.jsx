...
function MentalHealth() {
  const [products, setProducts] = useState(
    ProductsData.filter((product) => product.category === "Mental Health")
  );
  ...
  return (
    <>
      <TableContainer component={Paper}>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="mental health products table">
          <TableHead>
            <TableRow>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>Add New Mental Health Medicine</DialogTitle>
        <DialogContent>
          <Box
            component="form"
            sx={{
