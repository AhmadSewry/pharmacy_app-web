...
function BabyCare() {
  const [products, setProducts] = useState(
    ProductsData.filter(
      (product) => product.category === "Baby & Maternity Care"
    )
  );
  ...
  const productTypes = ["Cream", "Powder", "Ointment", "Liquid", "Drops"];
      ...
      <TableContainer component={Paper}>
        <Box sx={{ p: 2, textAlign: "center" }}>
          <Typography variant="h5" fontWeight="bold">
            Baby & Maternity Care Products
          </Typography>
        </Box>
        <Table sx={{ minWidth: 650 }} aria-label="baby care products table">
          <TableHead>
            <TableRow>
